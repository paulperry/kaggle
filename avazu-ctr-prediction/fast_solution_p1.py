...
submission = 'predict_p2.csv'  # path of to be outputted submission file

# B, model
alpha = .015  # learning rate
beta = 1.1   # smoothing parameter for adaptive learning rate
L1 = 20     # L1 regularization, larger value means more regularized
L2 = 40     # L2 regularization, larger value means more regularized
