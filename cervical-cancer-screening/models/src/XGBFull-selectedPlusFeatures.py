...
print('after merging diagnosis (procedure was merged to diagnosis)')
print(train.shape,test.shape)
...
#print('after merging pract_screen_ratio')
#print(train.shape,test.shape)
#del surgical,diagnosis,procedure,prescription
...
scl=decomposition.PCA(n_components=10,whiten=True)
...
#
clf = xgb.train(params, dtrain, num_boost_round=500, evals=watchlist, early_stopping_rounds=50,verbose_eval=True, maximize= False)
...
model='XGBOOST_onselectedPlusFeatures'
