...
diagnosis_train_counts=pd.read_csv('../features/diagnosis_train_counts.csv')
#print (diagnosis_train_counts.shape)
#print(np.unique(len(diagnosis_train_counts['patient_id'])))
diagnosis_test_counts=pd.read_csv('../features/diagnosis_test_counts.csv')
...
#
clf = xgb.train(params, dtrain, num_boost_round=1000, evals=watchlist, early_stopping_rounds=10,verbose_eval=True, maximize= False)
